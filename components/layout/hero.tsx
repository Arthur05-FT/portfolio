...
const Hero = () => {
  return (
    <header className="relative flex flex-col max-w-3xl border-r h-screen px-4 py-2">
      ...
      <h1
        className={
          "text-lg text-gray-800 dark:text-gray-200 " + bitter.className
        }
      >
        Arthur_
      </h1>
      <div className="flex flex-col justify-center pl-4 flex-1 gap-6">
        <div>
          <Link
            className="flex mb-6 px-4 text-sm hover:bg-border py-1 rounded-full w-fit items-center font-light bg-chart-5 gap-2 transition duration-200"
            href="#"
          >
            <FileText size={15} />
